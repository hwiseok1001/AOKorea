...
<jsp:include page="./head/script.jsp"></jsp:include>
<link rel="stylesheet" href="resources/assets/css/main.css?v=1.1">
<link rel="stylesheet" href="resources/assets/css/business.css?v=1.235">
<link rel="stylesheet" href="resources/assets/css/sub_con.css?v=1.1">
	...
	<section id="container" class="container">
		...
		<section class="sub_visual  int st_1 visual">
			...
			<div class="location" id="location">
				<div class="wrap">
					...
					<ul class="lcb_pc">
						<li class="home"><i class="text_hide">Home</i></li>
						<li class="no_depth"><span>기업소개</span></li>
		...
		<!-- <main class="con" id="con">
			<section class="cont_block wrap pt_100">
				<div class="greeting_wrap">
					<div class="img_box">
						<strong class="_tit"> <b class="isset"><span
								class="dp_inb aos-init aos-animate" data-aos="fade-up">디지털
									전환 시대,</span></b> <b class="isset"><span
								class="dp_inb aos-init aos-animate" data-aos="fade-up">디지털트윈의</span></b>
							<br class="md none"> <b class="isset"> <span
								class="dp_inb aos-init aos-animate" data-aos="fade-up">First
									Mover</span>
						</b>
						</strong>
					</div>
					<div class="txt_box">
						<p>
							홈페이지를 방문해 주신 여러분께 진심으로 감사드립니다.<br>
							<br> ㈜에이오코리아는 개인에서 산업까지 디지털트윈을 통해 개인의 행복과 산업의 발전을 도모합니다.<br>
							<br> 인재와 기술, 문화의 융합, 가상과 현실의 콘텐츠 통합을 바탕으로 끊임없이 새로운 길을 열어가는
							개척자 정신으로 가치를 창출하며, 열정과 전문성을 지닌 구성원과 함께 최고의 제품과 서비스를 제공합니다.<br>
							<br> 창의와 혁신을 통한 지속적인 성장으로 시장을 선도하고 지역 경제 활성화에 최선을 다하는 기업이
							되겠습니다. <br>
							<br> 새로운 경험의 세상을 만들기 위한 에이오코리아의 혁신은 오늘도 진행중입니다.<br>
							<br>
							<br> 감사합니다.<br>
							<br>
							<br>
						...
						<p class="sign">
							<b class="fw_600">AOKOREA 대표이사 이 열</b> <img
								src="resources/assets/img/main/sign.jpg" alt="">
